...
class DenseNet121(BaseBackbone):
    """
    DenseNet121 backbone adapted for mono Mel-spectrogram classification.
    Input:  [B, 1, T, M]
    ...
    def __init__(
        ...
        self.model.features.conv0 = conv3_to_conv1(self.model.features.conv0)

        in_features = self.model.classifier.in_features
        self.model.classifier = nn.Linear(in_features, classes_num)
        init_linear(self.model.classifier)
