...
class HistoryLogger:
    ...
    def _history_headers(self) -> list:
        return [
            ...
            'val_accuracy',
            'val_mAP',
            'val_auc_class_none', 'val_auc_class_strong', 'val_auc_class_middle', 'val_auc_class_weak',
            'val_ap_class_none', 'val_ap_class_strong', 'val_ap_class_middle', 'val_ap_class_weak',

            # 16 flattened confusion matrix columns (Actual vs Predicted)
            'cm_none_none', 'cm_none_strong', 'cm_none_middle', 'cm_none_weak',
            'cm_strong_none', 'cm_strong_strong', 'cm_strong_middle', 'cm_strong_weak',
            'cm_middle_none', 'cm_middle_strong', 'cm_middle_middle', 'cm_middle_weak',
            'cm_weak_none', 'cm_weak_strong', 'cm_weak_middle', 'cm_weak_weak'
        ]
    ...
    def _save_confusion_matrix_csv(self, path: str, matrix: np.ndarray) -> None:
        ...
        """
        labels = ['none', 'strong', 'middle', 'weak']
