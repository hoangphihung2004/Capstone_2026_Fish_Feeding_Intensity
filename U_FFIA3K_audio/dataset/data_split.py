    ...
    def split_data(self) -> Tuple[List[List], List[List], List[List]]:
        ...
        def build_entries() -> List[List]:
            if self.include_video:
                return (
                    ...
                    [self._make_multimodal_entry(wav, 2) for wav in middle_list] +
        ...
        if self.include_video:
            train_dict = (
                ...
                [self._make_multimodal_entry(wav, 2) for wav in middle_train] +
            ...
            test_dict = (
                ...
                [self._make_multimodal_entry(wav, 2) for wav in middle_test] +
            ...
            val_dict = (
                ...
                [self._make_multimodal_entry(wav, 2) for wav in middle_val] +
