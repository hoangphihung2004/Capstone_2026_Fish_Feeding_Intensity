...
def build_artifact_name(cfg: TrainConfig) -> str:
    ...
    distill_tag = "distillation" if cfg.distillation.enabled else "no_distillation"
    return f"MultimodalCustomDL_{cfg.model.name}_{distill_tag}_{cfg.evaluation_mode}_{timestamp}.zip"
